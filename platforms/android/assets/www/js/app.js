...
app=angular.module('starter', ['ionic', 'starter.controllers', 'ngCordova', 'ngCookies', 'utf8-base64', 'ng'])

app.constant('constants', {
  url:"http://192.168.0.234",
  token:"56bb6cef94b683.99198859",
  client: "clientTest",
  //ip:"127.0.0.1"
  ip:"192.168.0.225"
  //ip:"192.168.0.234"
})
app.run(function($ionicPlatform, $rootScope, $cookies, $ionicModal, $cordovaSQLite) {
  $ionicPlatform.ready(function() {
    ...
    document.addEventListener('deviceready', function(){
      db = $cordovaSQLite.openDB({name: 'my.db'});
        ...
        $cordovaSQLite.execute(db, 'CREATE TABLE IF NOT EXISTS modifLocal (id integer primary key, ligneModif integer, tableModif text, status text)'); 
        //db.close();
    }, false);
